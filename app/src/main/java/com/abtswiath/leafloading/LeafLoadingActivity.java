package com.abtswiath.leafloading;
...
public class LeafLoadingActivity extends BaseActivity implements OnSeekBarChangeListener,
        OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.findViewById(R.id.layout).setBackgroundColor(MyButton.getColor());
        initViews();
    ...
    private void initViews() {
        ...
        mClearButton = (MyButton) findViewById(R.id.clear_progress);
